...
function pDec(i){return parseInt(i,10);}
function pHex(i){return parseInt(i,16);}
...
function iBol(a){return typeof(a) === "boolean";}
function iInt(a){return pDec(a) === a;}
function iArr(a){return a && a.constructor === Array;}
function iDat(a){return a && a.constructor === Date;}
function iRxp(a){return a && a.constructor === RegExp;}
...
function eachField(obj, callback, scope){
  var key, value;
  if (!scope) {
    scope = null;
  }
  for (key in obj) {
    value = obj[key];
    if (callback.call(scope, obj, key, value) === false){
      return false;
    }
  }
  return true;
...
function eq(obj1, obj2) {
  ...
  switch (t1) {
    case "object":
      ...
      if (iFun(obj1) || iRxp(obj1)) {
        return String(obj1) === String(obj2);
      }
      else {
        return eachField(obj1, function(obj1, key, value){
          if (!eq(value, obj2[key])) {
            return false;
          }
        });
      }
    ...
    default:  //this is where all simple types end up (including string)
      return obj1 === obj2;
  }
  return true;
}