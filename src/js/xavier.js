...
var xmlaTreeView = new XmlaTreeView({
  ...
  showCatalogNodesToolbarButton: getXmlaTreeOption("showCatalogNodesToolbarButton"),
  ...
  catalogPaneToolbar: getXmlaTreeOption("catalogPaneToolbar"),
  ...
  showDimensionNodesToolbarButton: getXmlaTreeOption("showDimensionNodesToolbarButton"),
  showDimensionNodesCheckboxDisplayed: getXmlaTreeOption("showDimensionNodesCheckboxDisplayed"),
  showHierarchyNodesToolbarButton: getXmlaTreeOption("showHierarchyNodesToolbarButton"),
